...
class FirewallBlacklistCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $description = 'Laravel Firewall Blacklist.';
    ...
    public function __construct()
    {
        ...
        $this->blacklist  = storage_path('firewall/blacklist.txt');
    }
    ...
    private function list()
    {
        ...
        $this->table(['ip_address', 'blacklist'], $rows);
    }
